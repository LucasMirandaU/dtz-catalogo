...
### ?? App M�vil DTZ y PWA
- [x] Adaptaci�n multiplataforma de DTZMobile para compilar en Web (PWA) nativa y funcionar en Safari (iOS).
- [x] Componentes de Firma Digital condicionales (DOM Canvas para Web, WebView Canvas para Android).
- [x] Componentes de visor de im�genes adaptados a Web nativo.
- [x] Recepci�n, guardado (Base64) y renderizado de la Firma Digital de conformidad del cliente en los remitos PDF web (eparaciones.html).
- [x] Correcci�n de concurrencia al guardar M�ltiples �rdenes en la web de Taller.
- [x] Deploy continuo autom�tico de PWA en subdominio/subcarpeta v�a GitHub Pages.
- [ ] Deploy de instalador nativo Android (.apk) v�a EAS Build (Pendiente).
